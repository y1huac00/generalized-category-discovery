...
def get_cub_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
    ...
    original_whole_training_set = CustomCub2011(root=cub_root, transform=train_transform, train=True)
    whole_training_set = None
    if args.mini:
        subsample_indices = subsample_instances(deepcopy(original_whole_training_set), prop_indices_to_subsample=0.5)
    ...
    if args.mini:
        subsample_indices = subsample_instances(test_dataset, prop_indices_to_subsample=0.5)
