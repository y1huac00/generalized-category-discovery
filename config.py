...
# DATASET ROOTS
# -----------------
cifar_10_root = '/userhome/cs/yihuac/finalproject/generalized-category-discovery/datasets'
cifar_100_root = './datasets'
...
# OTHER PATHS
# -----------------
dino_pretrain_path = './pretrained_weights/dino_vitbase16_pretrain.pth'
feature_extract_dir = '/work/sagar/osr_novel_categories/extracted_features_public_impl'     # Extract features to this directory
exp_root = './experiments/testing'          # All logs and checkpoints will be saved here